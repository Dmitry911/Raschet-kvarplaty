...
private void jTextField12KeyPressed(java.awt.event.KeyEvent evt) {                                        
    if((evt.getKeyCode() == 40)||(evt.getKeyCode() == 10)){
      //при нажатии на кнопки Enter или Down идет переход фокуса на поле
...
private void jTextField15KeyPressed(java.awt.event.KeyEvent evt) {                                        
    if((evt.getKeyCode() == 40)||(evt.getKeyCode() == 10)){
      //при нажатии на кнопки Enter или Down идет переход фокуса на поле
...
private void jTextField18KeyPressed(java.awt.event.KeyEvent evt) {                                        
   if((evt.getKeyCode() == 40)||(evt.getKeyCode() == 10)){
      //при нажатии на кнопки Enter или Down идет 
      //запуск расчета  
      Raschet();
    }else{
        //System.out.println(evt.getKeyCode());
